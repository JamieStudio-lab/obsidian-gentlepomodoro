...
- **Quick Unlink:** One-click “Unlink Current Task” to clear the active task.
...
- **Rename-Safe (with ID):** If tasks include `🆔`, the current session updates on rename and you can refresh past logs by ID.
...
- **[Tasks](https://github.com/obsidian-tasks-group/obsidian-tasks):** Gentle Pomodoro can read tasks formatted by the Tasks plugin (e.g., `- [ ] Task ⏳ 2025-12-23 🆔 abc123`). This allows you to select your daily to-dos directly inside the timer view.
...
```markdown
- [ ] My important task ⏳ 2025-12-23 📅 2025-12-25 🆔 abc123
```

_Clicking a task links your current timer session to that specific item. If a task includes `🆔`, logs can be updated by ID even after renaming._
...
```md
- 🍅 Focus | Task:: [[Projects/MyProject.md|Write Documentation #docs]] | ID:: abcd12 | Start:: 2025-12-23 10:00:00 | End:: 2025-12-23 10:25:00 | Scheduled:: 1500 | Pauses:: [] | Total:: 1500 | Status:: finished
